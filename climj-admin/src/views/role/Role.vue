   ...
   <Modal v-model="editRoleModal"
     ...
     <Form ref="editRoleForm"
       ...
       <FormItem label="角色名称" prop="ukName">
         <Input v-model="editRoleForm.ukName" placeholder="请输入角色名称"/>
       </FormItem>

       <FormItem label="角色描述" prop="remark">
         <Input v-model="editRoleForm.remark" placeholder="请输入角色描述"/>
       </FormItem>
       ...
       <!-- <FormItem label="城市" prop="cityName">
          <Select @on-change="getCityIds" v-model="editRoleForm.cityId" placeholder="Select your city">
            <Option v-for="cityNameId in cityNameIds" :label="cityNameId.name" :value="cityNameId.pkId" :key="cityNameId.pkId">
              {{cityNameId.name}}
            </Option>
          </Select>
        </FormItem> -->
  ...
  export default {
    ...
    methods: {
      ...
      init(){
        ...
        //城市
        //   API.user.listCityAndId(this.params).then(({data}) => {
        //     if (data && data.code == 0) {
        //       this.cityNameIds = data.data;
        //     } else {
        //       this.$Message.error(data.msg);
        //     }
        //   }).catch((data) => {
      ...
      showEditRoleModal(params) {
        ...
        if (typeof params.row != 'undefined') {
          ...
          console.log("pkId为"+this.editRoleForm.pkId);
          this.editRoleForm.ukName = role.ukName;
          this.editRoleForm.remark = role.remark;
          // this.editRoleForm.cityId=role.cityId;
          // this.editRoleForm.cityId = role.cityId;
          // console.log("cityId为"+this.editRoleForm.cityId);
          // let cityIds = role.cityId;
          // this.cityId = this.$store.state.cityIds;
          // console.log("cityIds为"+cityIds);
          // console.log("cityId为"+this.cityId);
          let parm = {
