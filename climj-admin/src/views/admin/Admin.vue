<template>
  <div>
    <Row style="margin: 15px 0px" type="flex" justify="space-between">
      <Col span="5">
    ...
    <Modal v-model="editAdminModal"
      ...
      <Form ref="editAdminForm"
        ...
        <FormItem v-if="!isUpdate" label="账号" prop="ukAccount">
          <Input v-model="editAdminForm.ukAccount" placeholder="请输入管理员账号"/>
        </FormItem>
        <FormItem label="密码" prop="password">
          <Input v-model="editAdminForm.password" type="password" placeholder="请输入管理员密码"/>
        </FormItem>
        <FormItem label="确认密码" prop="rePassword">
          <Input v-model="editAdminForm.rePassword" type="password" placeholder="请确认管理员密码"/>
        </FormItem>
        <FormItem label="昵称" prop="nickname">
          <Input v-model="editAdminForm.nickname" placeholder="请输入管理员昵称"/>
        </FormItem>
        <FormItem label="邮箱" prop="email">
          <Input v-model="editAdminForm.email" placeholder="请输入管理员邮箱"/>
        </FormItem>
        <FormItem label="手机号" prop="phone">
          <Input v-model="editAdminForm.phone" placeholder="请输入管理员手机号"/>
        </FormItem>
