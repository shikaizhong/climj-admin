    ...
    <div class="right" style="width: 82%; padding-left: 7%; padding-top: 3%">
      <Form ref="editResourceForm"
        ...
        <FormItem label="菜单名称" prop="ukName">
          <Input class="form-input" v-model="editResourceForm.ukName" placeholder="请输入菜单名称"/>
        </FormItem>
        <FormItem label="路由路径" prop="path">
          <Input class="form-input" v-model="editResourceForm.path" placeholder="请输入路由路径"/>
        </FormItem>
        <FormItem label="资源权限" prop="perms">
          <Input class="form-input" v-model="editResourceForm.perms" placeholder="请确认资源权限"/>
        </FormItem>

        <FormItem label="排序数字" prop="orderNum">
          <Input class="form-input" v-model="editResourceForm.orderNum" placeholder="请输入排序数字"/>
        </FormItem>
